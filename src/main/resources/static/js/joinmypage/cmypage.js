...
document.addEventListener("DOMContentLoaded", function() {
    ...
    nicknameInput.addEventListener("input", function() {
		...
		if (nicknameValue.length === 0 || nicknameValue === originalNickname) {
		            setFeedback("닉네임", "");
		            return;
		        }
    ...
    function setFeedback(message, color) {
		...
		document.addEventListener("DOMContentLoaded", function() {
			...
			const originalEmailId = emailInput.value.trim();
			const originalEmailDomain = emailDomainInput.value.trim();
			...
			emailInput.addEventListener("blur", function() {
			        if (emailInput.value.trim() === "") {
			            emailInput.value = originalEmailId;
			    ...
			    emailDomainInput.addEventListener("blur", function() {
			        if (emailDomainInput.value.trim() === "") {
			            emailDomainInput.value = originalEmailDomain;
			            setEmailFeedback("이메일", ""); 
			        }
			    });
		    ...
		    function triggerEmailCheck() {
		        ...
		        if (emailId === originalEmailId && emailDomain === originalEmailDomain) {
		            setEmailFeedback("이메일", "");
		            return;
		        }
		    ...
		    function setEmailFeedback(message, color) {
		        ...
		        if (color === "red") {
		            ...
		            emailLabel.style.color = "var(--label-optional)"; 
		...
		document.addEventListener("DOMContentLoaded", function() {
		    ...
		    if (form) {
		        form.addEventListener("submit", function(event) {
		            ...
		            if (isRed("email") || isRed("emailDomain")) {
		                event.preventDefault();
		                alert("이메일을 확인해주세요.");
